...
urlpatterns = [
    ...
    path('Agriculturepractices/',views.Agriculturepractices,name='Agriculturepractices'),
    ...
    path('agriArticle/',views.agriArticle,name='agriArticle'),
...
admin.site.site_header="ಕೃಷಿ ಮಿತ್ರ (Agri-Mithra)"
admin.site.site_title="ಕೃಷಿ ಮಿತ್ರ (Agri-Mithra)"
admin.site.site_index_title="ಕೃಷಿ ಮಿತ್ರ (Agri-Mithra) ಜಾಲತಾಣಕ್ಕೆ ಸುಸ್ವಾಗತ"
