...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='product',
            name='category',
            field=models.CharField(choices=[('cr', 'vegetables'), ('ml', 'Fruits'), ('ls', 'LiveStocks'), ('ms', 'Equipments'), ('pn', 'Animal Feeds'), ('gh', 'Seeds'), ('cz', 'Pesticides'), ('ic', 'Vetrinary Medicines'), ('fc', 'Fertilzers')], max_length=2),
        ),
